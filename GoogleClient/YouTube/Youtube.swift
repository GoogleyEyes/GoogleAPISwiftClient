...
public class Youtube: GoogleService {
	...
	public var broadcastType: YoutubeLiveBroadcastsBroadcastType = .BROADCASTTYPEFILTEREVENT
	...
	public var textFormat: YoutubeCommentsTextFormat = .FORMATHTML
	/**
	...
	public var order: YoutubeSearchOrder = .SEARCHSORTRELEVANCE
	...
	public var moderationStatus: YoutubeCommentThreadsModerationStatus = .MODERATIONSTATUSPUBLISHED
	/**
	...
	public var filter: YoutubeSponsorsFilter = .POLLNEWEST
