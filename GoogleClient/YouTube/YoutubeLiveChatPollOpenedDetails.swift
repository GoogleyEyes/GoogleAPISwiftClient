//
//  YoutubeLiveChatPollOpenedDetails.swift
...
/// The LiveChatPollOpenedDetails model type for use with the Youtube API
public class YoutubeLiveChatPollOpenedDetails: ListType {
